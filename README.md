...
## Contributing
We encourage you to contribute to IfcXtreme! If you would like to contribute to IfcXtreme, you should subscribe to the developers mailing list ([IfcXtreme-dev](Dev@IfcXtreme.com)), where the developers of X3DOM discuss the development.
